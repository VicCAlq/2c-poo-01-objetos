...
const personagem = {
  ...
  pontosDeVida: 30, // Reduzido de 100 para 30 após a surra da plateia
  pontosDeMagia: 100,
  moedas: {
    ouro: 20,
    prata: 43,
...
${letra}`
  ...
  beberPocaoDeCura: function() {
    if (this.pocoes.cura > 0) {
      this.pontosDeVida = 100; // Recupera a vida para o valor total
      this.pocoes.cura -= 1;   // Remove uma poção do inventário
    } else {
