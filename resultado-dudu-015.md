Data de atualização: Dia 16/06/2026 às 16:36:03
 

| Questão | Teste | Entregue | Correto | Mensagem de Erro |
|---------|-------|----------|---------|------------------|
| AtvMetodoComplicado | O personagem possui o método comprar poções de cura: | ✅ | ❌ | TypeError: Cannot set properties of undefined (setting 'ouro') |
...
| AtvMetodoMedio | Testando o método consumi do personagem: | ✅ | ❌ | Error: O método possui mais argumentos do que o necessário |
...
| AtvObjeto | Componente possui a propriedade moedas:  | ✅ | ❌ | Error: Propriedade moedas não existe ou não possui o tipo correto |
